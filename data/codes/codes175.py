...
parser.add_argument('--num-steps', default=1, help='perturb number of steps, FGSM: 1, PGD-20: 20')
parser.add_argument('--step-size', default=0.003, help='perturb step size, FGSM: 0.031 , PGD-20: 0.003')

parser.add_argument('--random', default=True, help='random init for pgd attack')
...
def adv_attack(model, X, y, device):
    ...
    # Retrieve the number of iterations, step size and epsilon for the PGD attack
    num_steps = args.num_steps
    step_size = args.step_size
    epsilon = args.epsilon

    # Ensure first X_adv requires gradient
    ...
    for _ in range(num_steps):
        ...
        X_adv = X_adv + eta
        # Project the adversarial example back onto the given constrains (x+e)
